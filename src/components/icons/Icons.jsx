/* Central SVG icon library — import only what you need */

export function LogoMark({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <circle cx="16" cy="16" r="14"  stroke="#2c7488" strokeWidth="1.4" />
      <circle cx="16" cy="16" r="9"   stroke="#4b8697" strokeWidth="1.4" />
      <circle cx="16" cy="16" r="4.5" fill="#2c7488" />
    </svg>
  )
}
...
export function LogoMarkLarge() {
  return (
    <svg width="90" height="90" viewBox="0 0 90 90" fill="none">
      <circle cx="45" cy="45" r="43"  stroke="rgba(141,183,192,0.3)" strokeWidth="1" />
      <circle cx="45" cy="45" r="32"  stroke="#4b8697" strokeWidth="1.5" />
      <circle cx="45" cy="45" r="21"  stroke="#2c7488" strokeWidth="2" />
      <circle cx="45" cy="45" r="11"  fill="#2c7488" />
      <circle cx="45" cy="45" r="5"   fill="#8db7c0" />
      <circle cx="45" cy="2"   r="3.5" fill="#4b8697" opacity=".8" />
      <circle cx="88" cy="45"  r="3.5" fill="#4b8697" opacity=".8" />
      <circle cx="45" cy="88"  r="3.5" fill="#4b8697" opacity=".8" />
      <circle cx="2"  cy="45"  r="3.5" fill="#4b8697" opacity=".8" />
    </svg>
  )
}
...
export function PhoneIcon({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M4 2h5l2 5-3 2a14 14 0 006 6l2-3 5 2v5a2 2 0 01-2 2A18 18 0 012 4a2 2 0 012-2z"
...
/* ── Page illustration SVGs ── */
export function MiningIllustration() {
  return (
    <svg viewBox="0 0 380 340" fill="none">
...
export function TradeIllustration() {
  return (
    <svg viewBox="0 0 380 360" fill="none">
...
/* Hero deco SVGs (background illustrations) */
export function MiningHeroDeco() {
  return (
    <svg className="page-hero__deco" viewBox="0 0 500 400" fill="none" preserveAspectRatio="xMaxYMid slice">
